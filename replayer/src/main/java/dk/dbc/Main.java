...
import dk.dbc.solr.performance.replayer.SolrClientFactory;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        log.info("start");
        SolrClient solrClient = SolrClientFactory.makeSolrClient(config.getSolr());
        new Replayer(config, solrClient).run();
        log.info("end");
    }
